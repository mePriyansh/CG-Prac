...
String concatenatedStringBuilder =
concatenateWithStringBuilder(size);
long stringBuilderEndTime = System.nanoTime();
long stringBuilderTime = stringBuilderEndTime -
stringBuilderStartTime;
// Using StringBuffer
long stringBufferStartTime = System.nanoTime();
String concatenatedStringBuffer =
concatenateWithStringBuffer(size);
long stringBufferEndTime = System.nanoTime();
long stringBufferTime = stringBufferEndTime -
stringBufferStartTime;
System.out.println("Dataset Size: " + size);
System.out.println("String Concatenation Time: " + stringTime /
1000000.0 + " ms");
System.out.println("StringBuilder Concatenation Time: " +
stringBuilderTime / 1000000.0 + " ms");
System.out.println("StringBuffer Concatenation Time: " +
stringBufferTime / 1000000.0 + " ms");
System.out.println();
}
}
